...
# how many fusion gene pairs
data %>% select(sample, fusion) %>% unique() %>% nrow()
# 112

# how many fusion splicing isoforms
data %>% select(sample, fusion, LeftBreakpoint, RightBreakpoint) %>% unique() %>% nrow()
# 217
...
# how many genes and isoforms have both long and short read support:

...
# 79 shared and 35 unique have illumina support
...
Arriba_overlapping_preds = Arriba_overlapping_preds%>% select(lex_ordered_fusion_name, sample, type) %>% unique()

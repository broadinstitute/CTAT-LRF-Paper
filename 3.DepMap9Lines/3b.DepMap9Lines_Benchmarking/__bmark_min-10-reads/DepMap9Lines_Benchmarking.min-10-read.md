...
```
    ...
    ## 3 HCC1187|AKAP13--PDE8A JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 4  DMS53|R3HCC1L--PGAM1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 5   SKBR3|TATDN1--GSDMB JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 6    KIJK|YTHDF2--TAF12 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ##   num_progs
    ## 1         5
    ## 2         5
    ## 3         5
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## 1 JAFFAL            10 54  2 12 0.82 0.96 0.884
    ## 2 JAFFAL            11 50  2 16 0.76 0.96 0.848
    ## 3 JAFFAL            12 48  2 18 0.73 0.96 0.829
    ## 4 JAFFAL            13 47  2 19 0.71 0.96 0.816
    ## 5 JAFFAL            14 46  2 20 0.70 0.96 0.810
    ## 6 JAFFAL            15 43  2 23 0.65 0.96 0.775
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-10-read_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->

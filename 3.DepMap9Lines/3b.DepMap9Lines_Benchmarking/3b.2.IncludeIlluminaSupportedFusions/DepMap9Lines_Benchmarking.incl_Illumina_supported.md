...
```
    ...
    ## 1    RT112|FGFR3--TACC3 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 2  HCC1187|TMX2--SMTNL1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 3 HCC1395|PLA2R1--RBMS1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 4 HCC1187|PLXND1--TMCC1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 5       VCAP|PSMG1--UNK JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 6  SKBR3|SAMD12--MRPL13 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ##   num_progs
    ## 1         5
    ## 2         5
    ## 3         5
...
```
    ...
    ##   <chr>                <chr>              <int> <chr>      
    ## 1 RT112|FGFR3--TACC3   JAFFAL                 5 RT112      
    ## 2 RT112|FGFR3--TACC3   LongGF                 5 RT112      
    ## 3 RT112|FGFR3--TACC3   ctat-LR-fusion         5 RT112      
    ## 4 RT112|FGFR3--TACC3   fusionseeker           5 RT112      
    ## 5 RT112|FGFR3--TACC3   pbfusion               5 RT112      
    ## 6 HCC1187|TMX2--SMTNL1 JAFFAL                 5 HCC1187
...
```
    ...
    ## 1 LongGF             3 82  0 63 0.57   1 0.726
    ## 2 LongGF             4 71  0 74 0.49   1 0.658
    ## 3 LongGF             5 61  0 84 0.42   1 0.592
    ## 4 LongGF             6 57  0 88 0.39   1 0.561
    ## 5 LongGF             7 53  0 92 0.37   1 0.540
    ## 6 LongGF             8 52  0 93 0.36   1 0.529
...
```
    ...
    ## Warning in geom_point(aes(groups = pred_class_type, color = pred_class_type)):

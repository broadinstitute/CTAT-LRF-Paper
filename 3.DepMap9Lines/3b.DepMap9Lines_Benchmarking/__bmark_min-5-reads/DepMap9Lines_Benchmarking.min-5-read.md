...
```
    ...
    ## 1 HCC1187|KMT2E--LHFPL3 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 2  HCC1395|MFSD3--MROH1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 3 HCC1395|PRRC2B--FUBP3 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 4   K562|C16orf87--ORC6 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 5  SKBR3|CSNK2A1--PREX1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
...
```
    ...
    ##   <chr>                 <chr>              <int> <chr>      
    ## 1 HCC1187|KMT2E--LHFPL3 JAFFAL                 5 HCC1187    
    ## 2 HCC1187|KMT2E--LHFPL3 LongGF                 5 HCC1187    
    ## 3 HCC1187|KMT2E--LHFPL3 ctat-LR-fusion         5 HCC1187    
    ## 4 HCC1187|KMT2E--LHFPL3 fusionseeker           5 HCC1187    
    ## 5 HCC1187|KMT2E--LHFPL3 pbfusion               5 HCC1187    
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## 1 pbfusion             5 69 10 22 0.76 0.87 0.811
    ## 2 pbfusion             6 63  8 28 0.69 0.89 0.777
    ## 3 pbfusion             7 60  6 31 0.66 0.91 0.765
    ## 4 pbfusion             8 57  5 34 0.63 0.92 0.748
    ## 5 pbfusion            10 54  5 37 0.59 0.92 0.719
    ## 6 pbfusion            11 52  5 39 0.57 0.91 0.701
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-5-read_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

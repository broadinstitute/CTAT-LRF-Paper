...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->

``` r
p_fusion_counts_barplot + scale_y_continuous(trans='log10')
```

![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
```
    ...
    ## 1 LongGF             1 75 188 43 0.64 0.29 0.399
    ## 2 LongGF             2 66   0 52 0.56 1.00 0.718
    ## 3 LongGF             3 57   0 61 0.48 1.00 0.649
    ## 4 LongGF             4 53   0 65 0.45 1.00 0.621
    ## 5 LongGF             5 51   0 67 0.43 1.00 0.601
    ## 6 LongGF             6 49   0 69 0.42 1.00 0.592
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.illum_TP_uniq_FP.starF_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->

...
```
    ...
    ## 1    SKBR3|KLHDC2--SNTB1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 2   DMS53|R3HCC1L--PGAM1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 3    VCAP|PIK3C2A--TEAD1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 4 HCC1395|EIF3K--CYP39A1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 5  HCC1187|KMT2E--LHFPL3 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 6    VCAP|PDE4D--FAM172A JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ##   num_progs
    ## 1         5
    ## 2         5
    ## 3         5
...
```
    ...
    ##   <chr>                <chr>              <int> <chr>      
    ## 1 SKBR3|KLHDC2--SNTB1  JAFFAL                 5 SKBR3      
    ## 2 SKBR3|KLHDC2--SNTB1  LongGF                 5 SKBR3      
    ## 3 SKBR3|KLHDC2--SNTB1  ctat-LR-fusion         5 SKBR3      
    ## 4 SKBR3|KLHDC2--SNTB1  fusionseeker           5 SKBR3      
    ## 5 SKBR3|KLHDC2--SNTB1  pbfusion               5 SKBR3      
    ## 6 DMS53|R3HCC1L--PGAM1 JAFFAL                 5 DMS53
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## 1 LongGF             9 49  0 21 0.70   1 0.824
    ## 2 LongGF            11 48  0 22 0.69   1 0.817
    ## 3 LongGF            12 47  0 23 0.67   1 0.802
    ## 4 LongGF            13 46  0 24 0.66   1 0.795
    ## 5 LongGF            14 45  0 25 0.64   1 0.780
    ## 6 LongGF            15 40  0 30 0.57   1 0.726
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-9-read_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

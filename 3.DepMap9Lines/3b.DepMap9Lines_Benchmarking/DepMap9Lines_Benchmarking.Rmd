...
p_fusion_counts_barplot = fusion_preds %>% 
    filter(prog %in% c('ctat-LR-fusion.v0.12.0', 'JAFFAL', 'LongGF', 'fusionseeker', 'pbfusion_v0.3.1')) %>%
...
depmap_accuracy_lineplot = data %>% 
    filter(prog %in%  c('ctat-LR-fusion.v0.13.0-predev2', 'JAFFAL', 'LongGF', 'fusionseeker', 'pbfusion_v0.3.1') ) %>%
    mutate(prog = factor(prog, levels=c('ctat-LR-fusion.v0.12.0', 'JAFFAL', 'LongGF', 'fusionseeker', 'pbfusion_v0.3.1'))) %>%
...
data %>% 
    filter(prog %in% c('ctat-LR-fusion.v0.13.0-predev3', "JAFFAL")) %>%
...
truth_fusions_found_matrix  %>% filter(JAFFAL==1 & ctat.LR.fusion.v0.12.0 == 0)

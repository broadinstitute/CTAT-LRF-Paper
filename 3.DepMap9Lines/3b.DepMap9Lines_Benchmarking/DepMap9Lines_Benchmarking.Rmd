...
# as few as 2 in MJ and as many aas 33 in VCaP
...
ggsave(depmap_accuracy_lineplot, file="depmap_accuracy_lineplot.svg", width=7, height=4)
...
ggsave(depmap_TP_vs_FP_scatterplot, file="depmap_TP_vs_FP_scatterplot.svg", width=7, height=5)
...
ggsave(depmap_precision_recall_plot, file="depmap_precision_recall_plot.svg", width=5, height=3)
...
ggsave(depmap_cosmic_fusions_heatmap, file="depmap_cosmic_fusions_heatmap.svg", width=7, height=5)

...
PR_data = read.csv("data/min_2.okPara_ignoreUnsure.results.scored.PR", header=T, sep="\t", stringsAsFactors = F)
...
PR_AUC = read.csv("data/min_2.okPara_ignoreUnsure.results.scored.PR.AUC", header=F, sep="\t")

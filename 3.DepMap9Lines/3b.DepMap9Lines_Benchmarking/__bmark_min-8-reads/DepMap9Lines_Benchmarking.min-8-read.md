...
```
    ...
    ## 1       VCAP|HSF1--RERE JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 2 HCC1187|ALDOA--SHISA9 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 3  SKBR3|SUMF1--LRRFIP2 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 4    VCAP|INPP4A--HJURP JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 5     VCAP|TMPRSS2--ERG JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 6   SKBR3|TAF2--COLEC10 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ##   num_progs
    ## 1         5
    ## 2         5
    ## 3         5
...
```
    ...
    ##   <chr>                 <chr>              <int> <chr>      
    ## 1 VCAP|HSF1--RERE       JAFFAL                 5 VCAP       
    ## 2 VCAP|HSF1--RERE       LongGF                 5 VCAP       
    ## 3 VCAP|HSF1--RERE       ctat-LR-fusion         5 VCAP       
    ## 4 VCAP|HSF1--RERE       fusionseeker           5 VCAP       
    ## 5 VCAP|HSF1--RERE       pbfusion               5 VCAP       
    ## 6 HCC1187|ALDOA--SHISA9 JAFFAL                 5 HCC1187
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## 1 ctat-LR-fusion             8 68  5  4 0.94 0.93 0.935
    ## 2 ctat-LR-fusion             9 65  4  7 0.90 0.94 0.920
    ## 3 ctat-LR-fusion            10 62  4 10 0.86 0.94 0.898
    ## 4 ctat-LR-fusion            11 61  2 11 0.85 0.97 0.906
    ## 5 ctat-LR-fusion            12 58  2 14 0.81 0.97 0.883
    ## 6 ctat-LR-fusion            13 55  2 17 0.76 0.96 0.848
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-8-read_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

...
```
    ...
    ## 3   SKBR3|SAMD12--MRPL13 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 4   HCC1395|MFSD3--MROH1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 5 HCC1187|CTNND1--SMTNL1 JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ## 6         KIJK|NPM1--ALK JAFFAL,LongGF,ctat-LR-fusion,fusionseeker,pbfusion
    ##   num_progs
    ## 1         5
    ## 2         5
    ## 3         5
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## 1 pbfusion             4 79 11 27 0.75 0.88 0.810
    ## 2 pbfusion             5 68  9 38 0.64 0.88 0.741
    ## 3 pbfusion             6 63  7 43 0.59 0.90 0.713
    ## 4 pbfusion             7 60  6 46 0.57 0.91 0.701
    ## 5 pbfusion             8 57  5 49 0.54 0.92 0.681
    ## 6 pbfusion            10 54  5 52 0.51 0.92 0.656
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](DepMap9Lines_Benchmarking.min-4-read_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

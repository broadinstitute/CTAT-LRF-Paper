...
for line in annoFile:
    ...
    if "exon" in columns[2] or "CDS" in columns[2]:
            #print(columns[i], gene, columns[i+1])
            #if "gene_name" in columns[i] and gene == columns[i+1]:

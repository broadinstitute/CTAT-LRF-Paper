...
Om_data = read.table("Patient1_Om.Dondi_overian_CTAT_fusions.filtered_cells_and_dedup_umis.tsv", header=T, sep="\t", stringsAsFactors = F)
...
Om_cell_counts_by_method = read.table("Patient1_Om.Dondi_overian_CTAT_fusions.filtered_cells_and_dedup_umis.cell_counts_by_method.tsv", 
...
Tum_data = read.table("Patient1_Tum.Dondi_overian_CTAT_fusions.filtered_cells_and_dedup_umis.tsv", header=T, sep="\t", stringsAsFactors = F)
...
Tum_cell_counts_by_method = read.table("Patient1_Tum.Dondi_overian_CTAT_fusions.filtered_cells_and_dedup_umis.cell_counts_by_method.tsv", 
                                      header=T, sep="\t", stringsAsFactors = F)
...
fusion_annots = read.table("Patient1.fusion_annots", header=T, sep="\t", stringsAsFactors = F)
...
umap_base_data = read.table("data/Patient1_Tum/Patient1_Tum_UMAPcoords.txt", header=T, sep=",") %>%
    rename(barcodes=X)
celltypes = read.table("data/Patient1_Tum/Patient1_Tum.bc_to_celltype.tsv", header=T, sep="\t")

...
if (FALSE) {
    ROC_strict_results_file = "data/ax_splice/strict_allow_paralogs.combined_results.ROC.tsv"
    ROC_allow_reverse_results_file = "data/ax_splice/allow_rev_and_paralogs.combined_results.ROC.tsv"
    
    PR_AUC_strict_file = "data/ax_splice/strict_allow_paralogs.combined_results.PR_AUC.tsv"
    PR_AUC_allow_reverse_results_file = "data/ax_splice/allow_rev_and_paralogs.combined_results.PR_AUC.tsv"
} else {
    ROC_strict_results_file = "data/PacBioIsoSeqUb/strict_allow_paralogs.combined_results.ROC.tsv"
    ROC_allow_reverse_results_file = "data/PacBioIsoSeqUb/allow_rev_and_paralogs.combined_results.ROC.tsv"
    
    PR_AUC_strict_file = "data/PacBioIsoSeqUb/strict_allow_paralogs.combined_results.PR_AUC.tsv"
    PR_AUC_allow_reverse_results_file = "data/PacBioIsoSeqUb/allow_rev_and_paralogs.combined_results.PR_AUC.tsv"
}
...
ROC_strict_results = read.table(ROC_strict_results_file, header=T, sep="\t", stringsAsFactors = F)
ROC_strict_results$analysisType="strict_AP"

ROC_allow_reverse_results = read.table(ROC_allow_reverse_results_file, header=T, sep="\t", stringsAsFactors = F)
...
PR_AUC_strict_results = read.table(PR_AUC_strict_file, header=T, sep="\t", stringsAsFactors = F)
PR_AUC_strict_results$analysisType="strict_AP"

PR_AUC_allow_reverse_results = read.table(PR_AUC_allow_reverse_results_file, header=T, sep="\t", stringsAsFactors = F)
